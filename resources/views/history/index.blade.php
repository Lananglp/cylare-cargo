            ...
            <div class="box bg-nice-2 shadow-nice-master rounded-1 my-5">
                <div class="shadow-nice px-4 py-2 d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center I-js-1-left">
                        <span class="text-light d-flex align-items-center"><i class="bi bi-box me-2"></i> / History</span>
                    </div>
                ...
                <div class="">
                        ...
                        <table class="table table-sm I-js-1-center">
                            <thead>
                                <tr class="text-light border-secondary">
                                    ...
                                    <th class="fw-light text-center">old Qty</th>
                                    <th class="fw-light text-center">new Qty</th>
                                    <th class="fw-light text-center">Total</th>
                                    <th class="fw-light text-center">Date</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach($history as $key => $babi)
                                <tr class="text-light border-secondary">
                                @php
                                    $total = $history->currentPage() * $history->perPage();
                                    $number = $total - $history->perPage() + 1 + $key;
                                @endphp
                                    <td class="fw-light text-center">{{ $number  }}</td>
                                    <td class="fw-light">{{ $babi->name_items }}</td>
                                    <td class="fw-light">{{ $babi->info }}</td>
                                    <td class="fw-light text-center">{{ $babi->old_qty }}</td>
                                    <td class="fw-light text-center">{{ $babi->new_qty }}</td>
                                    <td class="fw-light text-center">{{ $babi->total_qty }}</td>
                                    <td class="fw-light text-center">{{ $babi->created_at }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
                    ...
                    <div class="shadow-nice flex-wrap d-flex justify-content-between align-items-center px-4 pb-2">
                        ...
                        <div class="mt-3 I-js-2-left">
                            <nav aria-label="Page navigation example">
                                <ul class="pagination pagination-sm">
                                    ...
                                    @else
                                    <li class="page-item">
                                        <a class="page-link page-link-hover bi bi-arrow-left-circle fs-4" href="{{ $history->previousPageUrl() }}"></a>
                                    </li>
                                    @endif
                                    ...
                                    <li class="page-item">
                                    <a class="page-link page-link-hover bi bi-arrow-right-circle fs-4" href="{{ $history->nextPageUrl() }}"></a>
                                    @else
                                    <li class="page-item">
                        ...
                        <div class="text-light my-3 ms-auto I-js-2-right">
                            ...
                            <a class="btn btn-sm btn-nice-3 me-1" href="/users">
                                <span class="bi bi-person-fill"><span class=""></span></span>
                            </a>
                        </div>
                    </div>
                </div>
