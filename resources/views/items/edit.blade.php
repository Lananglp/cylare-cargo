            ...
            <div class="box bg-nice-2 shadow-nice-master rounded-1 my-5">
                <div class="shadow-nice px-4 py-2 d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center js-animation-1">
                        <span class="text-light d-flex align-items-center"><i class="bi bi-box me-2"></i> / Items / edit</span>
                    </div>
                ...
                <div class="">
                    <div class="px-4 py-3">
                        <h1 class="fs-6 text-light text-center js-animation-10">Add new items</h1>
                        <form class="mt-3" action="{{ route('updateItem', $item->id ) }}" method="post">
                        @csrf
                            <div class="row">
                                ...
                                <div class="col-lg-6 js-animation-9">
                                    ...
                                    <input class="form-control form-control-sm form-control-nice @error('quantity') is-invalid @enderror" type="number" name="quantity" value="{{ old('quantity') }}" placeholder="count to add" required>
                                    @error('quantity')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
