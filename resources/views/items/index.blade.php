            ...
            <div class="box bg-nice-2 shadow-nice-master rounded-1 my-5">
                <div class="shadow-nice px-4 py-2 d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center I-js-1-left">
                        <span class="text-light d-flex align-items-center"><i class="bi bi-box me-2"></i> / Items</span>
                    </div>
                ...
                <div class="">
                        ...
                        <table class="table table-sm I-js-1-center">
                            <thead>
                                <tr class="text-light border-secondary">
                                    ...
                                    <th class="fw-light">Item name</th>
                                    <th class="fw-light text-center">Qty</th>
                                    <th class="fw-light text-center">Date</th>
                                    <th class="fw-light text-center">Options</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach($items as $key => $lananglp)
                                <tr class="text-light border-secondary">
                                @php
                                    $total = $items->currentPage() * $items->perPage();
                                    $number = $total - $items->perPage() + 1 + $key;
                                @endphp
                                    <td class="fw-light text-center">{{ $number  }}</td>
                                    <td class="fw-light">{{ $lananglp->name_items }}</td>
                                    <td class="fw-light text-center">{{ $lananglp->quantity }}</td>
                                    <td class="fw-light text-center">{{ $lananglp->created_at }}</td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center align-items-center">
                                            <a class="btn btn-sm btn-nice-2 btn-small me-2" href="{{ route('goReturn', $lananglp->id ) }}">
                                                <span class="bi bi-wrench"><span class=""></span></span>
                                            </a>
                                            <a class="btn btn-sm btn-nice-3 btn-small me-2" href="/items/{{ $lananglp->id }}/edit">
                                                <span class="bi bi-recycle"><span class=""></span></span>
                                            </a>
                                            <form action="/items/{{ $lananglp->id }}" method="post" id="items-delete">
                                            @csrf 
                                            @method('delete')
                                                <button class="btn btn-sm btn-nice-1 btn-small me-1" type="button" onclick="itemsDelete()">
                    ...
                    <div class="shadow-nice flex-wrap d-flex justify-content-between align-items-center px-4 pb-2">
                        ...
                        <div class="mt-3 I-js-2-left">
                            <nav aria-label="Page navigation example">
                                <ul class="pagination pagination-sm">
                                    ...
                                    @else
                                    <li class="page-item">
                                        <a class="page-link page-link-hover bi bi-arrow-left-circle fs-4" href="{{ $items->previousPageUrl() }}"></a>
                                    </li>
                                    @endif
                                    ...
                                    <li class="page-item">
                                    <a class="page-link page-link-hover bi bi-arrow-right-circle fs-4" href="{{ $items->nextPageUrl() }}"></a>
                                    @else
                                    <li class="page-item">
                        ...
                        <div class="text-light my-3 ms-auto I-js-2-right">
                            <a class="btn btn-sm btn-nice-2 me-1" href="/history">
                            ...
                            <a class="btn btn-sm btn-nice-3 me-1" href="/items/create">
                                <span class="bi bi-folder-plus"><span class=""></span></span>
                            </a>
                        </div>
                    </div>
                </div>
