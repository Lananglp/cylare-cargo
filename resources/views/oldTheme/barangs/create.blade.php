                ...
                <div class="col-7 py-5 shadow-keren">
                    <div class="px-5">
                        ...
                        <div>
                            ...
                            <ul>
                                <li class="text-light fw-light">Isi form dibawah untuk menambahkan barang.</li>
                            </ul>
                        </div>
                        <form action="">
                            <div class="">
                                <div class="my-3">
                                    <input type="text" name="unkown" value="{{ old('unkown') }}" class="form-control shadow-keren fw-semibold @error('unkown') is-invalid @enderror" placeholder="Nama barang">
                                ...
                                <div class="my-3">
                                    <input type="text" name="unkown" value="{{ old('unkown') }}" class="form-control shadow-keren fw-semibold @error('unkown') is-invalid @enderror" placeholder="Jumlah barang">
                                ...
                                <div class="col-12 mb-3 d-flex justify-content-end align-items-center">
                                    ...
                                    <div>
                                        <a href="/oldTheme/barangs/index" class="btn btn-sm shadow-keren px-5 bg-barak text-putih5">Kembali</a>
                                    </div>
                                </div>
                            </div>
                        </form>
