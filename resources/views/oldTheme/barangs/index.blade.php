            ...
            <div class="col-8 p-4 kotak shadow-keren">
                <div class="row d-flex align-items-start">
                    ...
                    <div class="col-6 text-end">
                        <a href="/oldTheme/rusaks/index" class="btn btn-sm bg-ijo3 mx-2 fw-semibold">Barang return</a>
                        <a href="/oldTheme/barangs/create" class="btn btn-sm bg-ijo fw-semibold">Tambah Barang</a>
                    </div>
                </div>
                @if ($barangs->count() > 0)
                <div class="bg-table">
                    <table class="table table-sm">
                        ...
                        <tbody>
                            ...
                            @endphp
                                ...
                                <td>{{ $barang->name_items }}</td>
                                <td class="text-center">{{ $barang->quantity }}</td>
                                <td class="text-center">{{ $barang->created_at }}</td>
                                <td class="text-center">
                                    <div class="">
                                    <button class="btn btn-sm bg-barak text-putih5 fw-semibold">Return barang</button>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
