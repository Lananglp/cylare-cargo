@extends('layouts.oldThemeMain2')

@section('content')

<div class="d-flex justify-content-center align-items-center vh-100">
    <div class="col-lg-4 bg-silver3 rounded-3 px-5 py-5">
        <form action="">
            <div class="mb-5">
            ...
            <a class="btn bg-ijo text-putih8 w-100 rounded-5 mb-3" href="/oldTheme/oldHome">Login</a>
            <p class="text-light fw-light text-center">Login admin untuk melakukan perubahan tambahan pada data barang.</p>

            <div class="pt-4 text-end">
                <a href="/home" class="text-ijo fw-semibold text-decoration-none rounded-5 mb-3">Kembali</a>
            </div>
        </form>
    </div>
</div>
