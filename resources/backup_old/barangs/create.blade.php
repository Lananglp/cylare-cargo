                ...
                <div class="col-7 py-5 shadow-keren">
                    <div class="px-5">
                        ...
                        <form action="/barangs" method="POST">
                            ...
                            <div class="">
                                <div class="my-3">
                                    <input type="text" name="nama_barang" value="{{ old('nama_barang') }}" class="form-control shadow-keren fw-semibold @error('nama_barang') is-invalid @enderror" placeholder="Nama barang">
                                ...
                                <div class="my-3">
                                    <input type="text" name="jumlah_barang" value="{{ old('jumlah_barang') }}" class="form-control shadow-keren fw-semibold @error('jumlah_barang') is-invalid @enderror" placeholder="Jumlah barang">
