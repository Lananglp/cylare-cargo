            ...
            <div class="col-8 p-4 kotak shadow-keren">
                <div class="row d-flex align-items-start">
                    ...
                    <div class="col-6 text-end">
                        <a href="/barangs" class="btn btn-sm bg-ijo3 fw-semibold">Kembali</a>
                    </div>
                </div>
                @if ($rusaks->count() > 0)
                <div class="bg-table">
                    <table class="table table-sm">
                        ...
                        <tbody>
                            ...
                            @endphp
                                ...
                                <td>{{ $rusak->nama_barang_rusak }}</td>
                                <td class="text-center">{{ $rusak->jumlah_barang_rusak }}</td>
                                <td class="text-center">{{ $rusak->barang_rusak_masuk }}</td>
                                <td>
                                    <form action="/rusaks/{{ $rusak->id }}" method="POST">
                                        @csrf 
                                        @method('delete')
                                        <div class="">
