                ...
                <div class="col-7 py-5 shadow-keren">
                    <div class="px-5">
                        ...
                        <form action="/rusaks" method="POST">
                            ...
                            <div class="">
                                <div class="my-3">
                                    <input type="text" name="nama_barang_rusak" value="{{ old('nama_barang') ? old('nama_barang') : $barang->nama_barang }}" class="form-control shadow-keren fw-semibold @error('nama_barang') is-invalid @enderror">
                                    <label class="px-3 pt-1 text-ijo fw-light" for="">Edit nama barang !</label>
                                    @error('nama_barang_rusak')
                                ...
                                <div class="my-3">
                                    <input type="text" name="jumlah_barang_rusak" value="{{ old('jumlah_barang') ? old('jumlah_barang') : $barang->jumlah_barang }}" class="form-control shadow-keren fw-semibold @error('jumlah_barang') is-invalid @enderror">
